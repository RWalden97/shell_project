...
union YYSTYPE
{
#line 23 "shell.y" /* yacc.c:355  */

		char   *string_val;
	

#line 138 "y.tab.cc" /* yacc.c:355  */
};
...
{
       0,    57,    57,    61,    62,    66,    70,    74,    75,    79,
      80,    84,    91,    92,    96,   113,   167,   178,   179,   183,
     186,   190,   200,   210,   220,   231,   243,   252
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "SUBSHELLCOMMAND", "NOTOKEN",
  "GREAT", "NEWLINE", "PIPE", "LESS", "GREATAMPERSAND", "GREATGREAT",
  "GREATGREATAMPERSAND", "AMPERSAND", "$accept", "goal", "commands",
  "command", "simple_command", "pipe_list", "command_and_args", "arg_list",
  "argument", "command_word", "iomodifier_opt_list", "background_opt",
...
{
      18,    15,    -6,    -6,    11,    17,    -6,    -6,     4,    -6,
      -6,    -6,    -6,    -6,    20,    23,    24,    25,    26,    27,
      28,    -5,    -6,    -1,    -6,    -6,    -6,    -6,    -6,    -6,
      -6,    -6,    29,    -6,    -6,    -6,    -6,    -6
};
...
{
       0,     0,    16,     7,     0,     0,     3,     5,    27,    10,
      13,     8,     1,     4,     0,     0,     0,     0,     0,     0,
       0,    20,    18,    11,    26,    21,     9,    22,    23,    24,
      25,    19,     0,    17,    14,    15,    12,     6
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -6,    -6,    -6,    30,    -6,    -6,    16,    -6,    -6,    -6,
      -6,    -6,    12
};
...
{
      14,    15,    34,    35,    17,    18,    19,    20,    31,    14,
      15,    12,    16,    17,    18,    19,    20,    -2,     1,     1,
       2,     2,    11,    24,     3,     3,    25,     2,    27,    28,
      29,    30,    26,    33,     0,    13,    37
};

static const yytype_int8 yycheck[] =
{
       5,     6,     3,     4,     9,    10,    11,    12,    13,     5,
       6,     0,     8,     9,    10,    11,    12,     0,     1,     1,
       3,     3,     7,     3,     7,     7,     3,     3,     3,     3,
       3,     3,    16,    21,    -1,     5,     7
};
...
static const yytype_uint8 yystos[] =
{
      ...
      23,     7,     0,    17,     5,     6,     8,     9,    10,    11,
      12,    24,    26,    21,     3,     3,    20,     3,     3,     3,
       3,    13,    25,    26,     3,     4,    22,     7
};
...
#line 1278 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 96 "shell.y" /* yacc.c:1646  */
    {
		...
		if( strchr((yyvsp[0].string_val),'*') != NULL || strchr((yyvsp[0].string_val),'?') != NULL){
			...
			arrayCounter = 0;	
			expandWildcard(NULL, strdup((yyvsp[0].string_val)));
			...
			Command::_currentSimpleCommand->insertArgument( strdup((yyvsp[0].string_val)) );\
		}
	}
...
#line 113 "shell.y" /* yacc.c:1646  */
    {
		...
		int pid;
		char * argument = (yyvsp[0].string_val);
...
#line 1405 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 200 "shell.y" /* yacc.c:1646  */
    {
		//printf("   Yacc: insert input \"%s\"\n", $2);
               if(Command::_currentCommand._inputFile == 0){
	       	 	Command::_currentCommand._inputFile = strdup((yyvsp[0].string_val));
	       }
	       else{
...
#line 1435 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1482 "y.tab.cc" /* yacc.c:1646  */
    break;
